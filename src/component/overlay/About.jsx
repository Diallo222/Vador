...
const About = (props) => {
  ...
  return (
    ...
    <div className="">
        <h1 className="text-3xl text-center md:text-left md:text-5xl font-Jedi4 font-serif text-black">
          Master Sith
        </h1>
      </div>
      ...
      <p className="font-medium text-sm text-black py-2 w-[250px] md:w-[300px] text-left tracking-wide">
